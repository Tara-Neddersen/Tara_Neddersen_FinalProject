...
const WEEKLY_PLAN = [
  { week: 1, topic: "spectroscopy", chapter: "9", title: "Spectroscopy (Ch 9)", days: [
    ...
    { task: "Flashcards: Spectroscopy + chapter summary & problems", pages: "pp. 429-440" },
    { task: "Quiz: Spectroscopy; redo missed cards", pages: "" },
  ...
  { week: 2, topic: "conjugation", chapter: "13", title: "Dienes & Conjugation (Ch 13)", days: [
    ...
    { task: "Flashcards: Conjugation; chapter summary & problems", pages: "pp. 634-640" },
  ...
  { week: 3, topic: "aromaticity", chapter: "14", title: "Aromaticity (Ch 14)", days: [
    ...
    { task: "Quiz: Aromaticity; cumulative review (Ch 9, 13, 14)", pages: "" },
    { task: "Problem Set 3 + start Midterm 1 prep", pages: "" },
  ]},
  { week: 4, topic: "eas", chapter: "15", title: "Midterm 1 + Aromatic Substitution (Ch 15)", days: [
    { task: "Midterm 1 review: Ch 9, 13, 14 (mixed flashcards + quiz)", pages: "" },
    { task: "Midterm 1 review: practice problems + reaction library", pages: "" },
    { task: "Midterm 1 (in class)", pages: "" },
    { task: "Read §15.1-15.3: EAS mechanism & reactions", pages: "pp. 694-712" },
  ...
  { week: 5, topic: "eas", chapter: "15", title: "Aromatic Substitution, cont. (Ch 15)", days: [
    ...
    { task: "Flashcards: Aromatic substitution; chapter summary", pages: "pp. 756-764" },
  ...
  { week: 6, topic: "carbonyl", chapter: "16", title: "Aldehydes & Ketones (Ch 16)", days: [
    ...
    { task: "Read §16.16-16.17: Wittig reaction; Flashcards & reaction library", pages: "pp. 814-819" },
  ...
  { week: 7, topic: "acids", chapter: "17", title: "Carboxylic Acids (Ch 17)", days: [
    ...
    { task: "Flashcards: Carboxylic acids; chapter summary", pages: "pp. 870-877" },
    { task: "Quiz: Carboxylic acids & derivatives", pages: "" },
    { task: "Cumulative review (Ch 15-17)", pages: "" },
    { task: "Problem Set 7 + start Midterm 2 prep", pages: "" },
  ]},
  { week: 8, topic: "acids", chapter: "18", title: "Midterm 2 + Acyl Derivatives (Ch 18)", days: [
    { task: "Midterm 2 review: Ch 15-17 (mixed flashcards + quiz)", pages: "" },
    { task: "Midterm 2 review: synthesis & mechanism practice", pages: "" },
    { task: "Midterm 2 (in class)", pages: "" },
  ...
  { week: 9, topic: "enolate", chapter: "18-19", title: "Acyl Derivatives -> Enolates (Ch 18-19)", days: [
    ...
    { task: "Flashcards: Enols & Enolates; reaction library", pages: "" },
  ...
  { week: 10, topic: "enolate", chapter: "19", title: "Enolates + Thanksgiving recess (Ch 19)", days: [
    { task: "Light review: redo tough flashcards (all topics)", pages: "" },
    { task: "Light review: skim the reaction library", pages: "" },
    { task: "Break - rest / optional catch-up", pages: "" },
    { task: "Break - Thanksgiving", pages: "" },
    { task: "Break - rest", pages: "" },
    { task: "Read §19.7-19.8: reactions related to aldol; the Claisen condensation", pages: "pp. 977-989" },
    { task: "Read §19.9-19.11: variations on Claisen; combined condensations", pages: "pp. 990-998" },
  ]},
  { week: 11, topic: "enolate", chapter: "19", title: "Finish Enolates + Course Review", days: [
    ...
    { task: "Flashcards: full enolate set; reaction library (enolate)", pages: "" },
    { task: "Quiz: Enols & Enolates; mixed cumulative quiz", pages: "" },
    { task: "Course review: aromatic + carbonyl synthesis", pages: "" },
    { task: "Course review: spectroscopy + mechanisms", pages: "" },
    { task: "Final prep: full mixed quiz; drill weak-area flashcards", pages: "" },
    { task: "Problem Set 10 + make a final-exam review plan", pages: "" },
  ]},
  { week: 12, topic: "spectroscopy", chapter: "Review", title: "Finals Week", days: [
    { task: "Final review: Ch 9, 13, 14 (mixed flashcards + quiz)", pages: "" },
    { task: "Final review: Ch 15, 16, 17, 18, 19 (mixed)", pages: "" },
    { task: "Final Exam (in class)", pages: "" },
    "",
    "",
    "",
    "",
