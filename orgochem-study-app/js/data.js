...
const COURSE = {
  ...
  exams: [
    { name: "Midterm 1", date: "2025-10-15", time: "5:30-6:45 pm", location: "CEMEX" },
    { name: "Midterm 2", date: "2025-11-12", time: "5:30-6:45 pm", location: "CEMEX" },
    { name: "Final Exam", date: "2025-12-10", time: "12:15-3:15 pm", location: "TBD" },
  ],
  policies: [
...
// First Monday of Autumn 2025 instruction (Stanford). The study plan is laid
// out week-by-week from this date through the final exam.
const COURSE_START = "2025-09-22";

/*
 * WEEKLY_PLAN drives the daily Study Plan. Each entry is one week (Mon..Sun);
 * the seven strings are the tasks for Mon, Tue, Wed, Thu, Fri, Sat, Sun.
 * The app turns these into real dated days and overlays the exam dates.
 *
 * Readings are mapped to Jones & Fleming, Organic Chemistry (5th Ed.) chapters.
 * Exact page numbers are left to fill in per day (each day has an editable
 * "pages" box in the app) so they can match the Canvas reading schedule.
 */
const WEEKLY_PLAN = [
  { week: 1, topic: "spectroscopy", chapter: "9", title: "Spectroscopy (Ch 9)", days: [
    "Read Ch 9: intro + IR spectroscopy",
    "Read Ch 9: mass spectrometry",
    "Read Ch 9: 1H NMR - chemical shift & integration",
    "Read Ch 9: 1H NMR splitting (n+1) + 13C NMR",
    "Flashcards: Spectroscopy + work IR/NMR problems",
    "Quiz: Spectroscopy; redo missed cards",
    "Problem Set 1 + weekly review",
  ]},
  { week: 2, topic: "conjugation", chapter: "13", title: "Dienes & Conjugation (Ch 13)", days: [
    "Read Ch 13: conjugation & the allyl system",
    "Read Ch 13: diene stability; 1,2- vs 1,4-addition",
    "Read Ch 13: the Diels-Alder reaction",
    "Read Ch 13: Diels-Alder stereochemistry (s-cis, endo)",
    "Flashcards: Conjugation; review Diels-Alder in Reactions",
    "Quiz: Conjugation",
    "Problem Set 2 + weekly review",
  ]},
  { week: 3, topic: "aromaticity", chapter: "14", title: "Aromaticity (Ch 14)", days: [
    "Read Ch 14: benzene & aromatic stability",
    "Read Ch 14: Huckel's rule (4n+2)",
    "Read Ch 14: antiaromaticity & annulenes",
    "Read Ch 14: aromatic ions & heterocycles (pyridine, pyrrole)",
    "Flashcards: Aromaticity",
    "Quiz: Aromaticity; cumulative review (Ch 9, 13, 14)",
    "Problem Set 3 + start Midterm 1 prep",
  ]},
  { week: 4, topic: "eas", chapter: "15", title: "Midterm 1 + Aromatic Substitution (Ch 15)", days: [
    "Midterm 1 review: Ch 9, 13, 14 (mixed flashcards + quiz)",
    "Midterm 1 review: practice problems + reaction library",
    "Midterm 1 (in class)",
    "Read Ch 15: EAS general mechanism (arenium ion)",
    "Read Ch 15: activating/deactivating directors",
    "Read Ch 15: halogenation, nitration, sulfonation",
    "Problem Set 4 + weekly review",
  ]},
  { week: 5, topic: "eas", chapter: "15", title: "Aromatic Substitution, cont. (Ch 15)", days: [
    "Read Ch 15: Friedel-Crafts alkylation & acylation",
    "Read Ch 15: multiple substituents & synthesis strategy",
    "Read Ch 15: nucleophilic aromatic substitution (SNAr)",
    "Flashcards: Aromatic substitution; reaction library (EAS)",
    "Quiz: Aromatic substitution",
    "Aromatic synthesis practice problems",
    "Problem Set 5 + weekly review",
  ]},
  { week: 6, topic: "carbonyl", chapter: "16", title: "Aldehydes & Ketones (Ch 16)", days: [
    "Read Ch 16: carbonyl structure & reactivity",
    "Read Ch 16: hydrates, acetals & protecting groups",
    "Read Ch 16: imines & enamines",
    "Read Ch 16: Grignard/hydride addition; Wittig",
    "Flashcards: Aldehydes & Ketones; reaction library",
    "Quiz: Aldehydes & Ketones",
    "Problem Set 6 + weekly review",
  ]},
  { week: 7, topic: "acids", chapter: "17", title: "Carboxylic Acids (Ch 17)", days: [
    "Read Ch 17: structure, nomenclature & acidity",
    "Read Ch 17: substituent effects on acidity",
    "Read Ch 17: synthesis & key reactions of acids",
    "Flashcards: Carboxylic acids; reaction library",
    "Quiz: Carboxylic acids & derivatives",
    "Cumulative review (Ch 15-17)",
    "Problem Set 7 + start Midterm 2 prep",
  ]},
  { week: 8, topic: "acids", chapter: "18", title: "Midterm 2 + Acyl Derivatives (Ch 18)", days: [
    "Midterm 2 review: Ch 15-17 (mixed flashcards + quiz)",
    "Midterm 2 review: synthesis & mechanism practice",
    "Midterm 2 (in class)",
    "Read Ch 18: acyl compounds & the reactivity ladder",
    "Read Ch 18: acyl chlorides, anhydrides, esters",
    "Read Ch 18: amides & nucleophilic acyl substitution",
    "Problem Set 8 + weekly review",
  ]},
  { week: 9, topic: "enolate", chapter: "18-19", title: "Acyl Derivatives -> Enolates (Ch 18-19)", days: [
    "Read Ch 18: hydrolysis, reduction & interconversions",
    "Read Ch 19: enols & enolates; alpha-acidity",
    "Read Ch 19: alpha-halogenation & alkylation",
    "Read Ch 19: the aldol reaction & condensation",
    "Flashcards: Enols & Enolates; reaction library",
    "Quiz: Enols & Enolates",
    "Problem Set 9 + weekly review",
  ]},
  { week: 10, topic: "enolate", chapter: "19", title: "Enolates + Thanksgiving recess (Ch 19)", days: [
    "Light review: redo tough flashcards (all topics)",
    "Light review: skim the reaction library",
    "Break - rest / optional catch-up",
    "Break - Thanksgiving",
    "Break - rest",
    "Read Ch 19: the Claisen condensation",
    "Read Ch 19: Michael addition; acetoacetic & malonic ester synthesis",
  ]},
  { week: 11, topic: "enolate", chapter: "19", title: "Finish Enolates + Course Review", days: [
    "Read Ch 19: conjugate addition recap; finish the chapter",
    "Flashcards: full enolate set; reaction library (enolate)",
    "Quiz: Enols & Enolates; mixed cumulative quiz",
    "Course review: aromatic + carbonyl synthesis",
    "Course review: spectroscopy + mechanisms",
    "Final prep: full mixed quiz; drill weak-area flashcards",
    "Problem Set 10 + make a final-exam review plan",
  ]},
  { week: 12, topic: "spectroscopy", chapter: "Review", title: "Finals Week", days: [
    "Final review: Ch 9, 13, 14 (mixed flashcards + quiz)",
    "Final review: Ch 15, 16, 17, 18, 19 (mixed)",
    "Final Exam (in class)",
    "",
    "",
    "",
